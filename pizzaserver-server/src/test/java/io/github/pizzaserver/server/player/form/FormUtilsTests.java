...
public class FormUtilsTests {
    ...
    public void shouldSerializeModalTypeCorrectly() throws IOException {
        ModalForm modalForm = new ModalForm.Builder().setTitle("Title")
                                                     .setContent("Content")
                                                     .setTrueButton("True Button")
                                                     .setFalseButton("False Button")
                                                     .build();

        JsonObject correctJSON = FormUtils.GSON.fromJson(IOUtils.toString(FormUtilsTests.class.getResourceAsStream(
                "/form/modal.json"), StandardCharsets.UTF_8), JsonObject.class);
    ...
    public void shouldSerializeCustomTypeCorrectly() throws IOException {
        CustomForm form = new CustomForm.Builder().setTitle("Title")
                                                  .setIcon(new FormImage(FormImage.Type.PATH, "path to image"))
                                                  .addElement(new DropdownElement.Builder().setText("Dropdown")
                                                                                           .setDefaultOptionIndex(1)
                                                                                           .addOptions("A", "B", "C")
                                                                                           .build())
                                                  .addElement(new InputElement("Input", "value", "placeholder"))
                                                  .addElement(new LabelElement("Label"))
                                                  .addElement(new SliderElement.Builder().setText("Slider")
                                                                                         .setMin(0)
                                                                                         .setMax(10)
                                                                                         .setStep(1)
                                                                                         .setValue(5)
                                                                                         .build())
                                                  .addElement(new StepSliderElement.Builder().setText("StepSlider")
                                                                                             .addSteps("A", "B", "C")
                                                                                             .setDefaultIndex(2)
                                                                                             .build())
        ...
        JsonObject correctJSON = FormUtils.GSON.fromJson(IOUtils.toString(FormUtilsTests.class.getResourceAsStream(
                "/form/custom.json"), StandardCharsets.UTF_8), JsonObject.class);
    ...
    public void shouldSerializeSimpleTypeCorrectly() throws IOException {
        SimpleForm form = new SimpleForm.Builder().setTitle("Title")
                                                  .setContent("Content")
                                                  .addButton(new ButtonElement("Button One"))
                                                  .addButton(new ButtonElement("Button Two",
                                                                               new FormImage(FormImage.Type.URL,
                                                                                             "url to image")))
                                                  .addButton(new ButtonElement("Button Three",
                                                                               new FormImage(FormImage.Type.PATH,
                                                                                             "path to image")))
                                                  .build();

        JsonObject correctJSON = FormUtils.GSON.fromJson(IOUtils.toString(FormUtilsTests.class.getResourceAsStream(
                "/form/simple.json"), StandardCharsets.UTF_8), JsonObject.class);
        JsonObject outputJSON = FormUtils.GSON.fromJson(FormUtils.toJSON(form), JsonObject.class);
    ...
    public void shouldDeserializeModalTypeResponseCorrectly() throws IOException {
        String response = IOUtils.toString(FormUtilsTests.class.getResourceAsStream("/form/response/modal.txt"),
                                           StandardCharsets.UTF_8);

        ModalFormResponse formResponse = (ModalFormResponse) FormUtils.toResponse(new ModalForm.Builder().build(),
                                                                                  mock(Player.class),
                                                                                  response);
    ...
    public void shouldDeserializeCustomTypeResponseCorrectly() throws IOException {
        String response = IOUtils.toString(FormUtilsTests.class.getResourceAsStream("/form/response/custom.json"),
                                           StandardCharsets.UTF_8);
    ...
    public void shouldDeserializeSimpleTypeResponseCorrectly() throws IOException {
        String response = IOUtils.toString(FormUtilsTests.class.getResourceAsStream("/form/response/simple.txt"),
                                           StandardCharsets.UTF_8);
