...
public class VanillaContentLoader {
    ...
    private static void loadBlocks() {
        ...
        BlockRegistry.getInstance().register(new BlockTypeAllow());
        BlockRegistry.getInstance().register(new BlockTypeAmethyst());
        BlockRegistry.getInstance().register(new BlockTypeAncientDebris());
        BlockRegistry.getInstance().register(new BlockTypeAzalea());
        BlockRegistry.getInstance().register(new BlockTypeBarrier());
        BlockRegistry.getInstance().register(new BlockTypeBed());
        BlockRegistry.getInstance().register(new BlockTypeBedrock());
        ...
        BlockRegistry.getInstance().register(new BlockTypeBlackstone());
        BlockRegistry.getInstance().register(new BlockTypeBlastFurnace());
        BlockRegistry.getInstance().register(new BlockTypeBrick());
        BlockRegistry.getInstance().register(new BlockTypeCalcite());
        ...
        BlockRegistry.getInstance().register(new BlockTypeClay());
        BlockRegistry.getInstance().register(new BlockTypeCoalBlock());
        BlockRegistry.getInstance().register(new BlockTypeCoalOre());
        BlockRegistry.getInstance().register(new BlockTypeCobbledDeepslate());
        BlockRegistry.getInstance().register(new BlockTypeCobblestone());
        BlockRegistry.getInstance().register(new BlockTypeCopperOre());
        BlockRegistry.getInstance().register(new BlockTypeCrackedDeepslateBrick());
        BlockRegistry.getInstance().register(new BlockTypeCrackedDeepslateTile());
        BlockRegistry.getInstance().register(new BlockTypeCrackedNetherBrick());
        BlockRegistry.getInstance().register(new BlockTypeCrackedPolishedBlackstoneBrick());
        ...
        BlockRegistry.getInstance().register(new BlockTypePodzol());
        BlockRegistry.getInstance().register(new BlockTypeSand());
