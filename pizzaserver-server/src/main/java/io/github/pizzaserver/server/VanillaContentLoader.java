...
import io.github.pizzaserver.server.block.behavior.impl.HorizontalDirectionBlockBehavior;
import io.github.pizzaserver.server.block.behavior.impl.IceBlockBehavior;
import io.github.pizzaserver.server.block.behavior.impl.RedstoneOreBehavior;
...
public class VanillaContentLoader {
    ...
    private static void loadBlocks() {
        ...
        BlockRegistry.getInstance().register(new BlockBlackstoneSlab());
        BlockRegistry.getInstance().register(new BlockBlackstoneSlab(SlabType.DOUBLE));
        ...
        BlockRegistry.getInstance().register(new BlockCobbledDeepslateSlab());
        BlockRegistry.getInstance().register(new BlockCobbledDeepslateSlab(SlabType.DOUBLE));
        ...
        BlockRegistry.getInstance().register(new BlockWoodenSlab(WoodType.CRIMSON));
        BlockRegistry.getInstance().register(new BlockWoodenSlab(WoodType.CRIMSON, SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockCryingObsidian());
        BlockRegistry.getInstance().register(new BlockCutCopperSlab());
        BlockRegistry.getInstance().register(new BlockCutCopperSlab(SlabType.DOUBLE));
        ...
        BlockRegistry.getInstance().register(new BlockDeepslateBrickSlab());
        BlockRegistry.getInstance().register(new BlockDeepslateBrickSlab(SlabType.DOUBLE));
        ...
        BlockRegistry.getInstance().register(new BlockDeepslateTileSlab());
        BlockRegistry.getInstance().register(new BlockDeepslateTileSlab(SlabType.DOUBLE));
        ...
        BlockRegistry.getInstance().register(new BlockStoneSlab(SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockStoneSlab(StoneSlabType.RED_SANDSTONE, SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockStoneSlab(StoneSlabType.END_STONE_BRICK, SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockStoneSlab(StoneSlabType.MOSSY_STONE_BRICK, SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockEmeraldOre());
        BlockRegistry.getInstance().register(new BlockCutCopperSlab(CopperType.EXPOSED));
        BlockRegistry.getInstance().register(new BlockCutCopperSlab(CopperType.EXPOSED, SlabType.DOUBLE));
        ...
        BlockRegistry.getInstance().register(new BlockLitFurnace(), new HorizontalDirectionBlockBehavior());
        ...
        BlockRegistry.getInstance().register(new BlockCutCopperSlab(CopperType.OXIDIZED));
        BlockRegistry.getInstance().register(new BlockCutCopperSlab(CopperType.OXIDIZED, SlabType.DOUBLE));
        ...
        BlockRegistry.getInstance().register(new BlockPolishedBlackstoneSlab());
        BlockRegistry.getInstance().register(new BlockPolishedBlackstoneSlab(SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockPolishedBlackstoneBrickSlab());
        BlockRegistry.getInstance().register(new BlockPolishedBlackstoneBrickSlab(SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockPolishedDeepslateSlab());
        BlockRegistry.getInstance().register(new BlockPolishedDeepslateSlab(SlabType.DOUBLE));
        ...
        BlockRegistry.getInstance().register(new BlockStoneSlab());
        BlockRegistry.getInstance().register(new BlockStoneSlab(StoneSlabType.RED_SANDSTONE));
        BlockRegistry.getInstance().register(new BlockStoneSlab(StoneSlabType.END_STONE_BRICK));
        BlockRegistry.getInstance().register(new BlockStoneSlab(StoneSlabType.MOSSY_STONE_BRICK));
        ...
        BlockRegistry.getInstance().register(new BlockWoodenSlab(WoodType.WARPED));
        BlockRegistry.getInstance().register(new BlockWoodenSlab(WoodType.WARPED, SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockWater());
        BlockRegistry.getInstance().register(new BlockWaxedCutCopperSlab());
        BlockRegistry.getInstance().register(new BlockWaxedCutCopperSlab(SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockWaxedCutCopperSlab(CopperType.EXPOSED));
        BlockRegistry.getInstance().register(new BlockWaxedCutCopperSlab(CopperType.EXPOSED, SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockWaxedCutCopperSlab(CopperType.OXIDIZED));
        BlockRegistry.getInstance().register(new BlockWaxedCutCopperSlab(CopperType.OXIDIZED, SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockWaxedCutCopperSlab(CopperType.WEATHERED));
        BlockRegistry.getInstance().register(new BlockWaxedCutCopperSlab(CopperType.WEATHERED, SlabType.DOUBLE));
        BlockRegistry.getInstance().register(new BlockCutCopperSlab(CopperType.WEATHERED));
        BlockRegistry.getInstance().register(new BlockCutCopperSlab(CopperType.WEATHERED, SlabType.DOUBLE));
        ...
        BlockRegistry.getInstance().register(new BlockWoodenSlab());
        BlockRegistry.getInstance().register(new BlockWoodenSlab(SlabType.DOUBLE));
