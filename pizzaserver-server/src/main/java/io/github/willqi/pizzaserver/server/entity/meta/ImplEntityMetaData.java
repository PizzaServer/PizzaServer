...
public class ImplEntityMetaData implements EntityMetaData {
    ...
    private final Map<EntityMetaPropertyName, ImplEntityMetaProperty<?>> properties = new HashMap<>();
    ...
    public void setByteProperty(EntityMetaPropertyName propertyName, byte value) {
        this.setProperty(propertyName, new ImplEntityMetaProperty<>(EntityMetaPropertyType.BYTE, value));
    }
    ...
    public void setShortProperty(EntityMetaPropertyName propertyName, short value) {
        this.setProperty(propertyName, new ImplEntityMetaProperty<>(EntityMetaPropertyType.SHORT, value));
    }
    ...
    public void setIntProperty(EntityMetaPropertyName propertyName, int value) {
        this.setProperty(propertyName, new ImplEntityMetaProperty<>(EntityMetaPropertyType.INTEGER, value));
    }
    ...
    public void setFloatProperty(EntityMetaPropertyName propertyName, float value) {
        this.setProperty(propertyName, new ImplEntityMetaProperty<>(EntityMetaPropertyType.FLOAT, value));
    }
    ...
    public void setLongProperty(EntityMetaPropertyName propertyName, long value) {
        this.setProperty(propertyName, new ImplEntityMetaProperty<>(EntityMetaPropertyType.LONG, value));
    }
    ...
    public void setStringProperty(EntityMetaPropertyName propertyName, String value) {
        this.setProperty(propertyName, new ImplEntityMetaProperty<>(EntityMetaPropertyType.STRING, value));
    }
    ...
    public void setNBTProperty(EntityMetaPropertyName propertyName, NBTCompound value) {
        this.setProperty(propertyName, new ImplEntityMetaProperty<>(EntityMetaPropertyType.NBT, value));
    }
    ...
    public void setVector3iProperty(EntityMetaPropertyName propertyName, Vector3i value) {
        this.setProperty(propertyName, new ImplEntityMetaProperty<>(EntityMetaPropertyType.VECTOR3I, value));
    }
    ...
    public void setVector3Property(EntityMetaPropertyName propertyName, Vector3 value) {
        this.setProperty(propertyName, new ImplEntityMetaProperty<>(EntityMetaPropertyType.VECTOR3, value));
    }

    private ImplEntityMetaProperty<?> getProperty(EntityMetaPropertyName propertyName, EntityMetaPropertyType expectedType) {
        ImplEntityMetaProperty<?> storedProperty = this.properties.get(propertyName);
    ...
    private void setProperty(EntityMetaPropertyName propertyName, ImplEntityMetaProperty<?> property) {
