...
public class BedrockSkinAnimation implements SkinAnimation {
    ...
    private BedrockSkinAnimation(int type, int frame, int skinHeight, int skinWidth, byte[] skinData) {
        this.type = type;
        this.frame = frame;
    ...
    public static class Builder {
        ...
        public BedrockSkinAnimation build() {
            return new BedrockSkinAnimation(this.type, this.frame, this.skinHeight, this.skinWidth, this.skinData);
        }
