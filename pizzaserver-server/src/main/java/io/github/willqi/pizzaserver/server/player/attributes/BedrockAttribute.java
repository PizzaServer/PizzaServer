...
public class BedrockAttribute implements Attribute, Cloneable {
    ...
    public BedrockAttribute(AttributeType attributeType, float minimumValue, float maximumValue, float defaultValue, float currentValue) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BedrockAttribute) {
            return ((BedrockAttribute) obj).getType().equals(this.getType());
        }
        return false;
    }
}
