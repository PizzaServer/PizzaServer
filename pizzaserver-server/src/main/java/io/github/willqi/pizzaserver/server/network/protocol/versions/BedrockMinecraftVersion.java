...
public abstract class BedrockMinecraftVersion implements MinecraftVersion {
    ...
    public BedrockMinecraftVersion(BedrockServer server) throws IOException {
        this.server = server;
    ...
    protected InputStream getProtocolResourceStream(String fileName) {
        return BedrockServer.getInstance().getClass().getResourceAsStream("/protocol/v" + this.getProtocol() + "/" + fileName);
    }
