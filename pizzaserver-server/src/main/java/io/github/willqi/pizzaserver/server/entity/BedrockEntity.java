...
import io.github.willqi.pizzaserver.server.entity.meta.BedrockEntityMetaData;
import io.github.willqi.pizzaserver.server.network.protocol.packets.SetEntityDataPacket;

import java.util.HashSet;
import java.util.Set;

public abstract class BedrockEntity implements Entity {
    ...
    private EntityMetaData metaData = new BedrockEntityMetaData();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BedrockEntity) {
            return NumberUtils.isNearlyEqual(((BedrockEntity) obj).getId(), this.getId());
        }
        return false;
    }
}
