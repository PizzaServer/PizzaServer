package io.github.willqi.pizzaserver.api.world.blocks.types;
...
public interface APIBlockType {
     ...
     */
    Set<APIBlockLoot> getLoot(APIPlayer player);
     ...
     */
    void onInteract(APIPlayer player, APIBlock block);
     ...
     */
    void onWalkedOn(APIPlayer player, APIBlock block);
     ...
     * @param block the block being walked on
     */
    void onUpdate(APIPlayer player, APIBlock block);
