...
public class ToolTypeID {
    ...
    public static final String WOOD_SWORD = "minecraft:wood_sword";
    public static final String WOOD_AXE = "minecraft:wood_axe";
    public static final String WOOD_PICKAXE = "minecraft:wood_pickaxe";
    public static final String WOOD_HOE = "minecraft:wood_hoe";
    public static final String WOOD_SHOVEL = "minecraft:wood_shovel";
    ...
    public static final String GOLD_SWORD = "minecraft:gold_sword";
    public static final String GOLD_AXE = "minecraft:gold_axe";
    public static final String GOLD_PICKAXE = "minecraft:gold_pickaxe";
    public static final String GOLD_HOE = "minecraft:gold_hoe";
    public static final String GOLD_SHOVEL = "minecraft:gold_shovel";
