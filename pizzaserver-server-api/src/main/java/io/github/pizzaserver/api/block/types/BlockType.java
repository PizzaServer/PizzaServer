...
public interface BlockType {
    ...
    BoundingBox getBoundingBox(int blockStateIndex);
     ...
     * If this is true, block collision will be taken into consideration.
     * @return if the block type is solid
     */
    boolean hasCollision();

    /**
     * If the block type can be replaced. (e.g. grass)
     * @return if blocks of this type can be replaced with another block.
     */
     ...
     */
    boolean prepareForPlacement(Entity entity, Block block, BlockFace face);
     ...
     * @param face the face this block was placed on
     */
    void onPlace(Entity entity, Block block, BlockFace face);
     ...
     */
    boolean onInteract(Entity entity, Block block, BlockFace face);
     ...
     */
    void onUpdate(BlockUpdateType type, Block block);
