...
public class BlockLocation {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BlockLocation) {
            ...
            return otherBlockLocation.getWorld().equals(this.getWorld()) && otherBlockLocation.getX() == this.getX()
                    && otherBlockLocation.getY() == this.getY() && otherBlockLocation.getZ() == this.getZ();
        }
        return false;
    }
    ...
    @Override
    public int hashCode() {
        return (43 * this.getX()) + (43 * this.getY()) + (43 * this.getZ()) + (43 * (
                this.getWorld() != null ? this.getWorld().hashCode() : 0));
    }

    @Override
    public String toString() {
        return "BlockLocation(level=" + this.getLevel().getName() + ", world=" + this.getWorld().getDimension() + ", x="
                + this.getX() + ", y=" + this.getY() + ", z=" + this.getZ() + ")";
    }
}
